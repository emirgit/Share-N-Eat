    ...
    useEffect(() => {
        const fetchStatistics = async () => {
            try {
                ...
                const [userResponse, postResponse, productResponse] = await Promise.all([
                        ...
                        {loading ? (
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 shadow hover:shadow-lg transition">
                                    ...
                                    <p className="text-gray-600 mt-2">Total Users: <span className="font-bold">{userCount}</span></p>
                                    <p className="text-gray-600">New Users Today: <span className="font-bold">-</span></p>
                                </div>
                                ...
                                <div className="bg-green-50 border border-green-200 rounded-lg p-4 shadow hover:shadow-lg transition">
                                    ...
                                    <p className="text-gray-600 mt-2">Total Posts: <span className="font-bold">{postCount}</span></p>
                                    <p className="text-gray-600">Posts Today: <span className="font-bold">-</span></p>
                                </div>
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 shadow hover:shadow-lg transition">
                                    ...
                                    <p className="text-gray-600 mt-2">Total Products: <span className="font-bold">{productCount}</span></p>
                                    <p className="text-gray-600">New Products: <span className="font-bold">-</span></p>
                                </div>
                            </div>
                        )}
                    </div>
