...
const ProductCommentCard = ({ comment, productId, isOwner, onCommentChange }) => {
    ...
    const handleUpdateComment = async () => {
        try {
            await axiosHelper(`/product-comments/${comment.id}`, 'PUT', {
                text: editText,
                productId: productId
            });
    ...
    const handleDeleteComment = async () => {
        try {
            await axiosHelper(`/product-comments/${comment.id}`, 'DELETE');
